...
<style>
    ...
    .btn-save { background: #66fcf1; color: #111; padding: 12px 20px; border: none; border-radius: 6px; font-weight: bold; cursor: pointer; width: 100%; font-size: 16px; }
</style>

<div>
    <h1 style="margin-top: 0; font-size: 32px; color: #fff;">Crear Categoría</h1>
